...
schema_payload:
  {
    ...
    "hero": {
      ...
      "h1": "сделай SAAS для продажи ai агентов",
      "lead": "Покажите ценность предложения \"сделай SAAS для продажи ai агентов\" и доведите пользователя до понятной заявки.",
    ...
    "faq": [
      {
        ...
        "answer": "Команда связывается с пользователем и уточняет условия."
      }
    ],
    "seo": {
      "title": "сделай SAAS для продажи ai агентов",
      "description": "Лендинг: сделай SAAS для продажи ai агентов"
    },
    "claims_to_validate": [
      {
        "claim": "Скорость внедрения и экономический эффект",
        "risk": "medium"
      }
    ]
  }
...
## Disallowed Copy
- Synthetic interview quotes as testimonials.
