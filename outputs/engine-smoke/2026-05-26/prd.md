...
schema_payload:
  {
    ...
    "problem": "Пользователь должен быстро понять ценность предложения \"Engine smoke лендинг\", довериться маршруту и оставить заявку без лишней неопределенности.",
    "goals": [
...
- swot.md
## Problem
Пользователь должен быстро понять ценность предложения "Engine smoke лендинг", довериться маршруту и оставить заявку без лишней неопределенности.
