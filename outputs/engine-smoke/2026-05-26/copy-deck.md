...
schema_payload:
  {
    ...
    "hero": {
      ...
      "h1": "Engine smoke лендинг",
      "lead": "Покажите ценность предложения \"Engine smoke лендинг\" и доведите пользователя до понятной заявки.",
    ...
    "seo": {
      "title": "Engine smoke лендинг",
      "description": "Лендинг: Engine smoke лендинг"
    },
    "claims_to_validate": [
      {
