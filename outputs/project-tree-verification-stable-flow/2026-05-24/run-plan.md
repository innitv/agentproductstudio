...
project tree verification stable flow
...
- 09-test-bench: Test Bench -> test-bench-result.md
- 10-qa: QA Review -> qa-report.md
- 11-release: Release -> release-notes.md

## Ограничения

- Это стартовый scaffold без выполненного research/PRD/frontend.
- Следующий этап обязан заполнить `recursive-brief.md`, затем deep research artifacts.
