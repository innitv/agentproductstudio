...
Goal: test stable artifact workflow
Date: 2026-05-24
...
- 00-intake: Intake and Recursive Brief
  owner: orchestrator
  artifacts: run-plan.md, handoff-bundle.md, recursive-brief.md
...
Validation:
- yarn workflow:validate outputs/test-stable-artifact-workflow/2026-05-24
