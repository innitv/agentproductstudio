...
schema_payload:
  ...
  implementation_notes:
    - "Реализован оригинальный лендинг VP Nexus."
...
| `apps/frontend/src/styles.css` | Новый адаптивный tactical style |
...
- Оригинальная визуальная система, не копия Riot/VALORANT.
- Нет Riot logo, agent art, maps, screenshots или official UI assets.
- Реализованы region checker, карточки пакетов, safety section и FAQ.
...
- Desktop: hero в 2 колонки, pack grid из 3 карточек.
