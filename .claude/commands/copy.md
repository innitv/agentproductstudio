...
- Делегируй этап через `Agent` tool с `subagent_type: copywriting`. Цель: собрать `copy-deck.md` с hero, CTA, секциями, FAQ, SEO-метаданными и списком claims to validate.
