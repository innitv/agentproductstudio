...
- Делегируй этап через `Agent` tool с `subagent_type: test-bench` с задействованием skill `funnel-analytics-verifier`. Цель: собрать `test-bench-result.md` с funnel analytics и результатом проверки главного сценария.
