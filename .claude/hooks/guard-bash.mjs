...
//
// Следствие проверок 1-2 (проверено на практике): строка вида `git add outputs/...` или
// `git push --force` заблокирует команду, даже если она стоит внутри `echo`, heredoc или
// grep-паттерна. Это осознанный fail-closed: защита важнее удобства цитирования. Нужен
// такой текст в команде — используй env-обход (CLAUDE_ALLOW_LEDGER_COMMIT / _FORCE_PUSH)
// или не пиши команду целиком в аргументе.
//
