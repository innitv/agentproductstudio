...
**Применимость.** Skill обязателен для `product_ui|frontend` surface всегда — витрина и машинная приёмка нужны независимо от того, участвовала ли Figma.
...
Применяется, только когда работа идёт по переданному Figma-файлу. Постоянной синхронизации кода и Figma в студии нет — Figma-кит не ведётся.
