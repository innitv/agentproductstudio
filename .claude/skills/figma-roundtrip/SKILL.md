...
## 🔴 Вариант начинается с границы, а не с записи

Запрос «сделай вариант», «переделай в другую тему», «попробуй иначе» допускает
несколько прочтений, и выбирать одно молча дорого. До первой записи в файл
назови три вещи и получи подтверждение:

1. **Что меняется** — какие полосы, слои, свойства.
2. **Что остаётся нетронутым** — обычно это и есть спорная часть.
3. **С чем сверяем** — какой существующий кадр или страница служит образцом;
   «на мой вкус» образцом не является.

Цена измерена 2026-09-04 на тёмном варианте главной A3 Pay: клон собирался
заново трижды. Первый раз в ночь ушла вся страница, включая светлые полосы;
второй — светлые остались, но перекрасились карточки и интерфейсы; третий
сошёлся только после того, как человек назвал образец — собранную ранее
страницу плательщика. Два клона выброшены целиком, притом что каждый проход
стоил нескольких минут записи в Figma и последующей сверки.

Признак, по которому ловится пропуск: в первом же сообщении о работе появляется
слово «я решил» или «логично сделать» применительно к границе, а не к способу.
Способ выбирает исполнитель, границу — человек.
