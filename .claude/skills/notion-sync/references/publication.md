# Публикация в Notion: входы, процедуры, состав evidence

Детали для `notion-sync`. Читать, когда skill запущен — то есть когда человек
попросил публикацию и approval получен.
