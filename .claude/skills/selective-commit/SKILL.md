...
Нормативный SOP — [`agent-pack/templates/selective-commit-sop.md`](../../../agent-pack/templates/selective-commit-sop.md). Skill делает его исполняемым и связывает с approval gate.
