...
- Мобильную поверхность проверяй в **профиле устройства** (`isMobile` + `hasTouch`), не в узком desktop-вьюпорте. Chromium ≠ WebKit — специфику Safari подтверждает только устройство.
