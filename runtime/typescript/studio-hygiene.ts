 ...
 *
 * История значений: 35 000 → **33 400** (2026-08-17). Аудит показал запас 231 символ, то есть
 * следующая правка индекса уронила бы весь агрегатор. Освободили 1 592 символа: §11.1 сжат до
 * указателя на `docs/architecture/delegation-lessons.md` (полный текст с замерами был там и
 * раньше — в индексе жила вторая редактируемая копия), описания четырёх кросс-стадийных
 * навыков сжаты до триггера, потому что процедура каждого лежит в самом навыке.
 */
export const CLAUDE_MD_CHAR_LIMIT = 33_400;
