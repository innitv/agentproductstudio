 ...
 *
 * Почему обёртка, а не `:root`: тем четыре, и в одном Storybook они стоят
 * рядом на одной странице. В `:root` переменные протекли бы на соседние
 * истории и на всё, что рендерится вне контейнера темы.
 *
 * ─── ПРО ПОРТАЛЫ ────────────────────────────────────────────────────────────
