 ...
 *
 * Хеш задаёт и экран, и тему: `#card-request-shadcn` — штатная тема реестра,
 * `#card-request-shadcn-branded` — брендовая, плюс две контрольные точки
 * эксперимента. Так темы сравниваются в живом приложении, а не только в
 * скриншотах Storybook.
 *
