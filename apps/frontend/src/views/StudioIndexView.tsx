...
const ROUTES: StudioRoute[] = [
  ...
  // Экраны «А3 Финанс» и «Портфолио» удалены 2026-08-03: собранный продукт
  // уезжает в свой репозиторий вместе с темой и приёмкой, иначе в студии и в
  // продукте живут две расходящиеся копии одного кода. Портфолио — в
  // `C:/Project/siteportfolio`, А3 удалён решением владельца.
]
