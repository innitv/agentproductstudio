      ...
      >
        <div className="relative h-full">
          ...
          <div
            ...
            style={{ height: "44px", paddingInline: "var(--bank-page-padding)" }}
          >
            <BankWordmark variant="micro" />

            {/* ── Зона 3: крестик, ⌀33, зона нажатия 44. Привязан к
                правому краю колонки — раскладка fluid. ───────────────── */}
            <div
              className="absolute"
              style={{
                top: 0,
      ...
      >
        ...
        <div className="shrink-0" style={{ marginTop: "16.7px" }}>
          ...
          <div
            ...
            style={{ marginTop: "18px", gap: "8px" }}
          >
            <BankWordmark variant="compact" color="var(--bank-text-secondary)" />
            <span
              style={{
                fontSize: "14px",
                fontWeight: 400,
