...
- 🔴 **Правил `CLAUDE.md`, изменённых в этой сессии, субагент не увидит:** его `claudeMd` — снимок на момент старта сессии, и даже свежий спавн получает старый текст (замерено 2026-07-30 тремя пробами). Обёртка, `skills:` и тела навыков читаются актуальными. Поменял правило и делегируешь сейчас — дублируй его в packet или начинай новую сессию.
