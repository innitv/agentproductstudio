...
*   **Панель метрик (Dashboard) [MUST]**: (Описание панели ROI-аналитики)
*   **Таблица активных ИИ-агентов [MUST]**: (Описание таблицы управления агентами)
*   **Встроенный чат-симулятор (RAG Sandbox) [MUST]**: (Описание песочницы для тестов)
*   **Форма добавления нового агента (No-code) [MUST]**: (Описание формы создания агента)
*   **Тарифная сетка (SaaS Billing) [MUST]**: (Описание виджета биллинга)
*   **Осознанно не в MVP [WON'T]**: (Что не входит в рамки MVP)
