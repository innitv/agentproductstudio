...
- Специалисты используются как ограниченные capabilities / agents-as-tools: Оркестратор сохраняет владение финальным результатом, а профильные агенты возвращают структурированные артефакты.
