...
| `01-research` | `research` | `goal`, `run-plan.md`, `handoff-bundle.md`, `stage-gate-ledger.md`, `recursive-brief.md`, `constraints`, `sources`, `source_policy` | `research-summary.md`, `scenario-user-flows.md`, `competitive-analysis.md`, `proto-personas.md`, `synthetic-interviews.md`, `swot.md` | PRD, IA, design, copy, QA, Notion publication. |
| `02-prd` | `prd` | `recursive-brief.md`, полный research pack (`research-summary.md`, `scenario-user-flows.md`, `competitive-analysis.md`, `proto-personas.md`, `synthetic-interviews.md`, `swot.md`), `handoff-bundle.md`, `goal`, `constraints` | `prd.md` | IA, design, copy, screens, frontend, QA, release. |
| `03-ia` | `ia` | `recursive-brief.md`, `prd.md`, `research-summary.md`, `scenario-user-flows.md`, `competitive-analysis.md`, `proto-personas.md`, `handoff-bundle.md` | `ia-brief.md` | Design, screens, frontend, QA. |
| `04-design` | `design` | `prd.md`, `research-summary.md`, `scenario-user-flows.md`, `ia-brief.md` | `design-brief.md` с Design System Strategy; для reference profile также `reference-analysis.md` | Copy, screens, frontend, visual reference review, QA. |
| `05-copy` | `copywriting` | `recursive-brief.md`, `prd.md`, `design-brief.md`, `research-summary.md`, `scenario-user-flows.md`, `competitive-analysis.md`, `proto-personas.md`, `handoff-bundle.md` | `copy-deck.md` | Screens, frontend, QA. |
