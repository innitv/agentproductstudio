...
Если пользователь пишет `мой сайт`, `мой сайт портфолио`, `портфолио`, `portfolio`, `siteportfolio`, `персональный сайт`, `сайт Ивана` или просит правку `/portfolio`, Claude должен считать это запросом к продукту `siteportfolio`.
